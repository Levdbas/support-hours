...
<fieldset>
  ...
  <div class="input-field">
    <input id="email" type="email" class="regular-text regular-text--email validate" id="<?php echo $name; ?>-email" name="<?php echo $name; ?>[email]" value="<?php if (!empty($this->email)) echo $this->email; ?>" />
