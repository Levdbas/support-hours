<fieldset>
	...
	foreach ($administrators as $administrator) {
		...
		<label for="<?php echo $name; ?>[users<?php echo $administrator->ID; ?>]">
			<input type="checkbox" name="<?php echo $name; ?>[users][]" id="<?php echo $name; ?>[users<?php echo $administrator->ID; ?>]" class="filled-in" value="<?php echo $administrator->ID; ?>" 
													<?php
													if (!empty($this->managers)) {
														checked((in_array($administrator->ID, $this->managers)));
													}
													?>
																																																																	 />
...
<fieldset>
	...
	<div class="">
		...
		<input id="email" type="email" class="components-text-control__input validate" id="<?php echo $name; ?>-email" name="<?php echo $name; ?>[email]" value="
																								  <?php
																									if (!empty($this->email)) {
																										echo $this->email;
																									}
