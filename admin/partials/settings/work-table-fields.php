<tr class="repeating" data-number="<?php echo $i; ?>">
  ...
  <td data-th="<?php _e('Description', $name); ?>">
	<input type="text" required placeholder="<?php _e('Description of the activity', $name); ?>" class="regular-text description validate" id="<?php echo $name; ?>-workFields-description" name="<?php echo $name; ?>[workFields][<?php echo $i; ?>][description]" value="
																					 <?php
