...
class Support_Hours {
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-support-hours-public.php';
	...
	private function define_public_hooks() {
		$plugin_public = new Support_Hours_Public( $this->get_plugin_name(), $this->get_version() );
